 ...
 *  2013-10-17
 */
public class ExcelExportUtilSelf {

    private ExcelExportUtilSelf() {
    }
     ...
     * @return
     */
    public static Workbook exportExcelMap(List<Map<String, Object>> list, ExcelType type) {
...
//                    (Class<?>) map.get("entity"), (Collection<?>) map.get("data"));
            service.createSheetForMap(workbook, (ExportParams) map.get("entity"), (List<ExcelExportEntity>) map.get("title"), (Collection<?>) map.get("data"));
        }
        return workbook;
    }
