select org_financeorg.name || '对账函' title,
       ...
       '2018-01-01' || '~' || '2019-12-31' daterange,
  ...
  from (select gl_balance.pk_group,
        ...
        select ar_gatheritem.pk_group,
         ...
         where ar_gatheritem.pk_deptid != '~'
           ...
           and substr(ar_gatheritem.billdate, 0, 10) >= '2018-01-01'
        ...
        select ic_saleout_b.pk_group,
         ...
         where ic_saleout_h.fbillflag = 3
           ...
           and substr(ic_saleout_b.dbizdate, 0, 10) >= '2018-01-01'
        ...
        select so_arsub_b.pk_group,
         ...
         where (so_arsub.fstatusflag = 2 or so_arsub.fstatusflag = 4)
           and so_arsub.dr = 0
           and so_arsub_b.dr = 0
           and substr(so_arsub_b.dbilldate, 0, 10) >= '2018-01-01'
 ...
 where 1 = 1
   ...
   and bd_customer.pk_customer = '0001A110000000002TNV'
   and org_dept.pk_dept in
       (select pk_dept
         ...
         where 11 = 11
           ...
           and (org_dept.innercode like '01RO139M%'))
